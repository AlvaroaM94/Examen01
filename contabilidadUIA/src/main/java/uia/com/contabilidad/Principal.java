...
import uia.com.contabilidad.clientes.Pago;
...
import uia.com.contabilidad.gestor.DecoradorPagos;
...
public class Principal {
	public static void main(String[] args) {				
		...
		Gestor contabilidad = new Gestor("C:\\Users\\amigu\\git\\contabilidadUIA-AS\\contabilidadUIA\\ListaProveedores.json");		
		 ...
		 DecoradorPagos gestorPagos = new DecoradorPagos(gestorCheques, "Cheque");
